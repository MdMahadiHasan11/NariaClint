...
export default function BookingForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axiosPublic.post('/booking', BookingInfo)  // Replace with your actual endpoint
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-8 space-y-6">
            ...
            <div>
              ...
              />
              {errors.countryDestinations && <p className="text-red-500 text-sm mt-1">{errors.countryDestinations.message}</p>}
            </div>
